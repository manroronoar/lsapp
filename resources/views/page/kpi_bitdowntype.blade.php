...
<div class="box box-success">
        ...
        <div class="box-body">
                ...
                <h1 class="bold" align="center">BIT TYPE CONFIG</h1>
                </div>
        </div>   
      </div>
           ...
           <table id="user_table" class="table table-bordered table-striped">
            <thead>
                    ...
                    <tr class="bg-green color-palette">             
                       <th scope="row" class="text-center">Bi. Bit</th>
                       <th scope="row" class="text-center">Bi. Type</th>
                   ...
                   <div class="modal-body">
                    ...
                    <form method="post" id="sample_form" class="form-horizontal">
                     ...
                     <div class="form-group">
                       <label class="control-label col-md-4" >Bi. Bit</label>
                       <div class="col-md-8">
                        <input type="text" name="Bi_Bit" id="Bi_Bit" class="form-control" />
                       </div>
                      </div>
           
                      <div class="form-group">
                       <label class="control-label col-md-4">Bi. Type</label>
                       <div class="col-md-8">
                        <input type="text" name="Bi_Type" id="Bi_Type" class="form-control" />
                       </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8">                                                        
                         <input type="text" name="Bi_User" id="Bi_User" class="form-control" value=" {{ Auth::user()->enid }}" readonly/>                               
                        </div>
                       </div> 
  ...
  var jq = $.noConflict(); 
    jq(document).ready(function(){
     ...
     jq('#sample_form').on('submit', function(event){
      ...
      {
       action_url = "{{ route('bit.store') }}";
      }
    
      if(jq('#action').val() == 'Edit')
      {
       action_url = "{{ route('bit.update') }}";
      }
