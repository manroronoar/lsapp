    ...
    <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">ADD kpi_headerSettings CONFIG</h3>
              ...
              <div align="right">
               ...
               <div class="table-responsive">
                <table id="user_table" class="table table-bordered table-striped">
                 <thead>
                  <tr>
                   <th scope="row">Hs_Mc</th>
                            <th scope="row">Hs_Target/Hour</th>
                            <th scope="row">Hs_Drawing</th>
                            <th scope="row">Hs_Shift</th>
                            <th scope="row">Hs_Employee</th>
                            <th scope="row">Hs_Customer</th>
           ...
           <div class="modal-body">
            ...
            <form method="post" id="sample_form" class="form-horizontal">
             ...
             <div class="form-group">
               <label class="control-label col-md-4" >Mc</label>
               <div class="col-md-8">
              ...
              <div class="form-group">
               <label class="control-label col-md-4">Target/Hour</label>
               <div class="col-md-8">
                <input type="text" name="Hs_Target/Hour" id="Hs_Target/Hour" class="form-control" />
               </div>
              </div>
   
              <div class="form-group">
               <label class="control-label col-md-4">Drawing</label>
               <div class="col-md-8">
              ...
              <div class="form-group">
               ...
               <div class="col-md-8">
                <input type="text" name="Hs_Employee" id="Hs_Employee" class="form-control" />
               </div>
              </div>
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                  <label class="control-label col-md-4">Customer</label>
                  <div class="col-md-8">
                      <select class="testdropdows form-control" name="testdropdows" id="testdropdows">
                          <option value="">Select mcnumber</option>
                             @foreach ($listmcnumber as $item)
                         <option value="{{$item->Mc_Number}}">{{$item->Mc_Number}}</option>
                             @endforeach
