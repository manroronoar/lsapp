            ...
            <form method="post" id="sample_form" class="form-horizontal">
             ...
             <div class="form-group">
              ...
              <div class="form-group">
               ...
               <div class="col-md-8">
                <input type="text" name="Sh_Timestart" id="Sh_Timestart" class="form-control timepicker" />
               </div>
              </div>
              ...
              <div class="form-group">
               ...
               <div class="col-md-8">
                <input type="text" name="Sh_Timestop" id="Sh_Timestop" class="form-control timepicker" />
               </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-8">                              
                      @if(Auth::check() && Auth::user()->isAdmin())
                      <input type="text" name="Sh_User" id="Sh_User" class="form-control" value=""/>
                      @else
