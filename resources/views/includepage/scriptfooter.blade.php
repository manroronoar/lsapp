...
<script src="AdminLTE-master/bower_components/morris.js/morris.min.js"></script>
  ...
  <!-- FLOT CHARTS -->
  <script src="{{ asset('AdminLTE-master/bower_components/Flot/jquery.flot.js') }}"></script> 
  <!-- FLOT RESIZE PLUGIN - allows the chart to redraw when the window is resized -->
  <script src="{{ asset('AdminLTE-master/bower_components/Flot/jquery.flot.resize.js') }}"></script> 
  <!-- FLOT PIE PLUGIN - also used to draw donut charts -->
  <script src="{{ asset('AdminLTE-master/bower_components/Flot/jquery.flot.pie.js') }}"></script> 
  <!-- FLOT CATEGORIES PLUGIN - Used to draw bar charts -->
  <script src="{{ asset('AdminLTE-master/bower_components/Flot/jquery.flot.categories.js') }}"></script> 

  <!-- jQuery Knob -->
  <script src="AdminLTE-master/bower_components/jquery-knob/js/jquery.knob.js"></script>
  <!-- Sparkline -->
...
<!-- ChartJS -->
<script src="AdminLTE-master/bower_components/chart.js/Chart.js"></script>
